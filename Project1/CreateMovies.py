...
class Main():
    ...
    DilWaleDulhaniyaLejayeinge = movie.Movie("Dil Wale Dulhaniya Lejayeinge",
    ...
    TwoStates = movie.Movie("Two States",
    ...
    ThreeIdiots = movie.Movie("Three Idiots",
    ...
    movies_list = [DilWaleDulhaniyaLejayeinge,
                   Lagaan,
                   TwoStates,
                   ThreeIdiots]
